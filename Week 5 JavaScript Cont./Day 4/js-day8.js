...
console.log(d);
// new date is a time stamp so won't keep updating as time goes on. Will only capture the time when the page is opened/refreshed.
...
console.log(history);
// this is a string below which can be used for date before 1900 
